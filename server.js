...
// Local database URI.
const DATABASE = "mongodb+srv://sisi:Sitraka1@cluster0.1phmo.mongodb.net/myFirstDatabase?retryWrites=true&w=majority";
// Local port.
const LOCAL_PORT = 8080;

// Init the server
mongodb.MongoClient.connect(process.env.MONGODB_URI || DATABASE,
    {
